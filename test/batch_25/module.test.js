import { validateBatchPayload, getBatchIdentifier, initializeBatch } from '../../sdk/src/utils/batch_25/index.js';

describe('cnMarket Batch 25 Module', () => {
    ...
    it('should return correct identifier', () => {
        if (getBatchIdentifier() !== 'CN_BATCH_25') throw new Error('Invalid identifier');
    });
});
